...
void printList(Node*);
void appendList(Node**, int); //pass in a number by reference
                              // a linked list is type node*
                              // a node** lets you see the address of the first value?
...
void deleteFromList(Node* list1)
{
    ...
    if(head->next != nullptr) // if there is another node in front
    {
